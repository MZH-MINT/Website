        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="text-white font-bold text-xl ml-2">PowerMaster</span>
            </div>
            <p className="mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/products/car" className="hover:text-white">Car Batteries</Link></li>
              <li><Link href="/products/inverter" className="hover:text-white">Inverter Batteries</Link></li>
              <li><Link href="/#battery-assistant" className="hover:text-white">Battery Finder</Link></li>
              <li><Link href="#" className="hover:text-white">Warranty Policy</Link></li>
              <li><Link href="#" className="hover:text-white">Battery Maintenance Tips</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/auth" className="hover:text-white">Sign In / Register</Link></li>
              <li><Link href="/profile" className="hover:text-white">My Orders</Link></li>
              ...
              <li><Link href="/profile" className="hover:text-white">Profile Settings</Link></li>
            </ul>
          </div>
