    ...
    <section className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Our Premium Battery Collection</h2>
          <p className="text-lg text-gray-600">Browse through our wide range of high-quality batteries</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Car Batteries */}
          <div className="relative overflow-hidden group rounded-xl bg-white shadow-md transition-all hover:shadow-lg">
            <img 
        ...
        {/* Top Brands */}
        <div className="mt-16">
          <h3 className="text-xl font-semibold text-center mb-8">Top Battery Brands We Offer</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 items-center">
            {brands.map((brand) => (
              <div key={brand} className="bg-white p-4 rounded-lg flex items-center justify-center grayscale hover:grayscale-0 transition-all">
                <div className="h-12 w-full flex items-center justify-center">
                  <div className="text-center font-bold text-lg text-gray-500">{brand}</div>
                </div>
              </div>
            ))}
          </div>
