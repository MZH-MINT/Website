      ...
      <main className="py-10 bg-gray-50 dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 bg-white dark:bg-black rounded-lg shadow-md overflow-hidden">
            ...
            {/* Hero Section */}
            <div className="bg-primary-700 p-8 flex items-center justify-center hidden md:block">
              <div className="text-white max-w-md">
                <h2 className="text-3xl font-bold mb-4">Power up with PowerMaster!</h2>
                ...
                <div className="mt-8">
                  <img 
                    src="https://images.unsplash.com/photo-1620714223084-8fcacc6dfd8d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=80" 
                    alt="Car battery installation" 
                    className="rounded-lg shadow-lg object-cover w-full max-h-40"
                  />
                </div>
              </div>
            </div>
